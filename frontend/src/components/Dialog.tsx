...
export function DnDialog(): React.ReactElement {
      ...
      <Dialog open={isOpen} onClose={close} className="relative z-10">
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            <DialogPanel
              transition
              className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all data-closed:translate-y-4 data-closed:opacity-0 data-enter:duration-300 data-enter:ease-out data-leave:duration-200 data-leave:ease-in sm:my-8 sm:w-80% sm:max-w-80% data-closed:sm:translate-y-0 data-closed:sm:scale-95"
            >
...
export function DnDialogConfirm(): React.ReactElement {
  return <></>;
}

export function DnDialogForm() {
  return (
    <form>
