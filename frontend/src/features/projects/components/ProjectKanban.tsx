...
export default function ProjectKanban() {
  ...
  const onDragEnd = async (result: DropResult) => {
    ...
    try {
      ...
      Logger.error('Failed to update project position', err as Error);
      // Revert on error
      setRecords(records);
                            ...
                            return (
                              ...
                              >
                                <div className="flex justify-between items-start mb-2">
                                  ...
                                  <span className="px-2 py-0.5 bg-primary-50 dark:bg-primary-900/30 text-primary-600 dark:text-primary-400 rounded text-[9px] font-bold">
                                    {project.methodology}
                                  </span>
                                </div>
