...
export default function LoginPage() {
  ...
  return (
    <div className="flex-1 flex flex-col justify-center items-center py-12 px-4 sm:px-6 lg:px-8 page-enter relative overflow-hidden bg-surface-50 dark:bg-slate-950 transition-colors duration-300">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-96 h-96 bg-primary-200/50 dark:bg-primary-900/20 rounded-full blur-3xl mix-blend-multiply dark:mix-blend-soft-light opacity-50 animate-blob"></div>
      <div className="absolute top-[20%] right-[-10%] w-96 h-96 bg-indigo-200/50 dark:bg-indigo-900/20 rounded-full blur-3xl mix-blend-multiply dark:mix-blend-soft-light opacity-50 animate-blob animation-delay-2000"></div>
